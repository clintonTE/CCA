...
#NOTE: the below is the main specification. DO NOT DELETE!
const REVENUE_LOWER_BOUND = 500_000.0
const WEALTH_LOWER_BOUND = 1_000_000.0

#NOTE: the below specification is mostly for the wealth distribution graphs
#const REVENUE_LOWER_BOUND = 100_000.0
#const WEALTH_LOWER_BOUND = 1.0

#NOTE: the below is for testing
#const REVENUE_LOWER_BOUND = 10_000_000.0
#const WEALTH_LOWER_BOUND = 10_000_000.0

const DATA_SUFFIX = ("W$(Int(round(WEALTH_LOWER_BOUND/1000)))" *
  "R$(Int(round(REVENUE_LOWER_BOUND/1000)))")
...
const PROCESSED_DATA_NAME = "endowmentData_$DATA_SUFFIX"
const CONSOLIDATED_NAME = "summaryTableConsolidated"
const PRIMARY_OUTPUT_NAME = "primaryOutput_$DATA_SUFFIX"
...
const GRAPH_EXT = "pdf"
const GRAPH_SUFFIX = "$(DATA_SUFFIX)"
const GRAPH_SIZE = (1000,750)

const TABLE_SUFFIX = "$(DATA_SUFFIX)"
...
const TAIL_MIN_ENTRIES_PER_FILE = 50
...
const LITE_WINSORIZE_PROP = 0.005 #set to 0.05 for enhanced winsorization
...
include("EndowmentCode\\ReportAndAnalyze\\RegressionSpecificationsV2.jl")
include("EndowmentCode\\ReportAndAnalyze\\RegressionsV2.jl")
