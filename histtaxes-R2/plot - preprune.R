...
iaw$pdf.start("creditrates2.pdf", wd = 12, ht = 6)
with(d, {
    ...
    text(1975, 0.069, "LT Treasuries", col = "blue", cex = 0.8, srt = 30)
...
iaw$pdf.start("InterestTaxes.pdf", wd = 12, ht = 6)
with(d, {
    ...
    text(1965, 0.19, "Average marginal tax rates from\n filed tax returns (NBER)", col = "black", cex = 0.8, srt = 0)
})
iaw$pdf.end()

iaw$pdf.start("FedWithStateTaxes.pdf", wd = 12, ht = 6)
with(d, {
...
iaw$pdf.start("MarginalAndAverage.pdf", wd = 12, ht = 6)
with(d, {
...
iaw$pdf.start("vanguard.pdf", wd = 12, ht = 6)
with(d, {
    ...
    text(1995, .135, "Investment Grade Vanguard Return \n (Net of 10-year realized inflation)", col = "black", cex = 0.8, srt = 0)
    text(1992.5, .09, "Agency Vanguard Return\n (Net of 10-year realized inflation)", col = "blue", cex = 0.8, srt = 0)
    text(1993, 0.055, "20-year Treasury Bond Rate \n (Nominal)", col = "red", cex = 0.8, srt = 0)
    text(1993, 0.025, "20-year Treasury Bond Rate \n (CPI Smoothed Real)", col = "red", cex = 0.8, srt = 0)
})
iaw$pdf.end()

iaw$pdf.start("tipsInflation.pdf", wd = 12, ht = 6)
with(d, {
    ...
    text(2004.5, 0.05, "CPI 3Y Smoothed Inflation", col = "black", cex = 0.8, srt = 0)
    text(2004, 0.01, "TIPS Inflation", col = "blue", cex = 0.8, srt = 0)
})
iaw$pdf.end()
