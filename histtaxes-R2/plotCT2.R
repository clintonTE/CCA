...
with(d, {
    ...
    text(1975, 0.072, "20Y T-Bond", col = "blue", cex = 0.8, srt = 30)
    text(1978, 0.05, "20Y AAA Municipals", col = "blue", cex = 0.8, srt = 30)
...
with(d, {
    ...
    iaw$vline(1987, lty = 2);
    text(1988, 0.7, "Reagan Tax Reform", cex = 0.7, srt = 90);
