...
#############################Shared Constants###########
const TEX_PATH = "C:\\Users\\Clinton Tepper\\Dropbox\\Apps\\Overleaf\\Endowment Project"
...
const MAX_SERIALIZATION_WORKERS = 3
...
const REVENUE_LOWER_BOUND = 10_000_000.
...
const LARGE_DIFFERENCE_CUTOFF = .05
...
#include("EndowmentCode\\EndowmentReturns.jl") #some scripts related to educational endowments
