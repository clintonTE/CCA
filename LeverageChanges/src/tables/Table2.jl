...
function maketable2(panel::DataFrame; trialrunonly::Bool=trialrunonly,
  ...
  T2_PANEL_B_ROWLABEL::Dict = Dict(
    ...
    :sd=>"SD Net Lead",
    :Δsd=>"SD Net 2Y Delta",
    :LLret1year=>"\\smallskip Compound Raw Lagged\$^2\$",
  ...
  T2_PANEL_B_VOLFIELDS::NTuple{2,Symbol} = (:LLvol1yearnet, :vol1yearnet)
  T2_PANEL_B_RETFIELDS::NTuple{2,Symbol} = (:LLret1year, :ret1year)
