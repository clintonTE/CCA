...
const CRSPD_EXPANDED_NAME = "CRSP-D"
...
const MIN_ANNOUNCEMENT_DELAY = 3 #this is the min delay between fiscal year end and earnings releases
...
const REQUIRED_DAILY_TRAILING = 121
const REQUIRED_MONTHLY_TRAILING = 6

const VALIDATE_MERGED = true

const USE_QUARTERLY_DATES = (!IVO_REP) #NOTE

const LAG_MONTH_RANGE = 10:14
...
const VWCRSP_INDEX = :vwindd #ewindd
...
const CQUART_FCONTROLS = :LLret1year
...
const CQUART_FCONTROLS_D = :LLret1year
...
const CQUART_FCONTROLS_RMD = :LLret1year
...
const CQUART_FCONTROLS_BRS_D = :LLret1year
...
const RETAINED_COLS_COMP = [:gvkey; :fyear; :fyrmonth; :Lfyrmonth; :LLfyrmonth;
  :fdate; :Lfdate; :LLfdate; :ayrmonth;
  :linkeffdate; :linkenddate; :Nadate; :brse; :brsd; :brsx; :netliab;
  :ddate; :adate; :lpermno; :begindate; :enddate; USED_COMPA_VALUE_FIELDS;
  :bknegcash; :cash; :netdebt; :bkequity; :bkflev; :bkliab; :mkequity; :nop; :inv;
  :sic]

#only accept compelte cases, used in FormDataSeries
const REQUIRED_ANNUAL_DATA_COLS  = [:gvkey; :permno; :sic;
  :bknegcash; :bkflev; :bkliab; :Lbknegcash;
  :Lbkflev; :Lbkliab; :mknegcash; :mkflev; :mkliab; :Lmknegcash; :Lmkflev; :Lmkliab;
  :at; :bm; :nop; :inv; :cash; :bkequity; :mkequity;
  :fyear; :fyrmonth; :Lfyrmonth;]
...
const RETAINED_COLS_DATA_SERIES = unique([:gvkey; :fyear; :fyrmonth; :ayrmonth;
  :linkeffdate; :linkenddate; :Nadate; :brse; :brsd; :brsx;
  :ddate; :adate; :lpermno; :begindate; :enddate; :bkequity;
  :mkequity; :Lmkequity; :mkat;:lmkequity; :Llmkequity;
  ...
  CQUART_FGROUPS_FD;
  :vol1yearnet; :Lvol1yearnet; :LLvol1yearnet; :LDvol1yearnet; :fret; :fvol;
  :Dlat; :LDlat; :ret1year; :Lret1year; :LLret1year; :bm; :Lbm; :nop; :Lnop;
  (s->Symbol(:LD, s)).(CQUART_FVALS)])

#Table controls
const CONTROL0 = Vector{Symbol}()
const T1_CONTROL4 = [:Lbm; :Llmkequity; :LDlat; :Lnop]
const T1_CONTROL10 = [T1_CONTROL4; :L12ret1year; :L24ret1year; :fret;
  :L12vol1yearret; :L24vol1yearret; :fvol]
############################IVO constants
