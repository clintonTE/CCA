...
function maketable5(panel::DataFrame; trialrunonly::Bool=trialrunonly,
  ...
  T5_PANEL_A_IDX::Dict = Dict(
    ...
    :std=>2,
    :stdxt=>3)
  T5_PANEL_A_NAME::String = "t5panela-$(REPLICATION_TYPE[])"
  ...
  T5_PANEL_B_VOLFIELDS::NTuple{2,Symbol} = (:LLvol252d, :vol252d)
  T5_PANEL_B_RETFIELDS::NTuple{2,Symbol} = (:LLret12m, :ret12m)

  T5_PANEL_B_NAME::String = "t5panelb-$(REPLICATION_TYPE[])"
  ...
  T5_PANEL_C_NAME::String = "t5panelc-$(REPLICATION_TYPE[])"

  T5_PANEL_C_MIN_ROWS::Int = 24
  ...
  T5_PANEL_D_NAME::String = "t5paneld-$(REPLICATION_TYPE[])"
