...
function maketable8(dist::DataFrame;
  ...
  T8_PANEL_A_NAME::String = "t8panela-$(REPLICATION_TYPE[])-$(DIST_TYPE[])"
  ...
  T8_PANEL_B_NAME::String = "t8panelb-$(REPLICATION_TYPE[])-$(DIST_TYPE[])"
  ...
  T8_PANEL_C_NAME::String = "t8panelc-$(REPLICATION_TYPE[])-$(DIST_TYPE[])"
