...
function maketable9(cumex::AbstractDataFrame;
  ...
  T9_PANEL_A_NAME::String = "t9panela-$(REPLICATION_TYPE[])-$(DIST_TYPE[])"
  ...
  T9_PANEL_B_NAME::String = "t9panelb-$(REPLICATION_TYPE[])-$(DIST_TYPE[])"
  ...
  T9_PANEL_C_NAME::String = "t9panelc-$(REPLICATION_TYPE[])-$(DIST_TYPE[])"
