...
function maketable1(;trialrunonly::Bool=trialrunonly,
    runpanela::Bool=true,
    runpanelb::Bool=true,
    runpanelc::Bool=true,
    runpaneld::Bool=true
  ...
  runpanela && table12panelA(apanel,
    fvals = T1_FVALS,
  ...
  runpanelb && table12panelB(apanel,
    fvals = T1_FVALS,
...
function maketable2(;trialrunonly::Bool=trialrunonly,
    runpanela::Bool=true,
    runpanelb::Bool=true,
    runpanelc::Bool=true,
    runpaneld::Bool=true
  ...
  T2_PANEL_A_IDX::Dict = Dict(
    ...
    :std=>2,
    :stdxt=>3)
  T2_PANEL_A_NAME::String = "t2panela-$(REPLICATION_TYPE[])"
  ...
  #these are pairs of lagged and unlagged fields
  T2_PANEL_B_VOLFIELDS::NTuple{2,Symbol} = (:LLvol252d, :vol252d)
  T2_PANEL_B_RETFIELDS::NTuple{2,Symbol} = (:LLret12m, :ret12m)

  T2_PANEL_B_NAME::String = "t2panelb-$(REPLICATION_TYPE[])"
  ...
  T2_PANEL_C_NAME::String = "t2panelc-$(REPLICATION_TYPE[])"
  ...
  T2_PANEL_D_NAME::String = "t2paneld-$(REPLICATION_TYPE[])"
...
function table12panelA(panel::DataFrame;
...
function table12panelB(panel::DataFrame;
...
function table12panelC(panel::DataFrame;
  ...
  for i ∈ 1:length(fss)
    sfrs::Vector{FactorRegression} = manyFF(fss[i], parallel=parallel)
...
function table12panelD(panel::DataFrame;
