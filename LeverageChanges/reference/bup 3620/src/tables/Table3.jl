...
function maketable3(panel::DataFrame; trialrunonly::Bool=trialrunonly,
  ...
  T3_PANEL_A_FOCALS::Dict = Dict(
    :mknegcash=>[:Lvol252dnet, :LLvol252dnet, :LDmknegcash],
    :bknegcash=>[:Lvol252dnet, :LLvol252dnet, :LDbknegcash],
    :mkflev=>[:Lvol252dnet, :LLvol252dnet, :LDmkflev],
    :bkflev=>[:Lvol252dnet, :LLvol252dnet, :LDbkflev],
    :mkliab=>[:Lvol252dnet, :LLvol252dnet, :LDmkliab],
    :bkliab=>[:Lvol252dnet, :LLvol252dnet, :LDbkliab])
  ...
  T3_PANEL_A_RET::Dict = Dict(
    :mknegcash=>:vol252dnet,
    :bknegcash=>:vol252dnet,
    :mkflev=>:vol252dnet,
    :bkflev=>:vol252dnet,
    :mkliab=>:vol252dnet,
    :bkliab=>:vol252dnet)
  ...
  runpanela && table3panelA(apanel,
    ...
    T3_PANEL_B_CLUSTERS::Vector{Symbol} = [:permno, :fyear]
