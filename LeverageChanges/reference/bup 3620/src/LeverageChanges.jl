...
const RETAINED_COLS_COMP = [:gvkey; :fyear; :fyrmonth; :Lfyrmonth; :ayrmonth; :fdate; :Lfdate;
...
const RETAINED_COLS_DATA_SERIES = unique([:gvkey; :fyear; :fyrmonth; :ayrmonth;
  ...
  CQUART_FGROUPS_FD;
  :vol252dnet; :Lvol252dnet; :LLvol252dnet; :LDvol252dnet;
...
const T1_CONTROL10 = [T1_CONTROL4; :L12ret12m; :L24ret12m;
  :ayret12m; :L12vol252dret; :L24vol252dret; :ayvol252dret]
############################IVO constants
