...
#=const CQUART_FCONTROLS_BRSD_D = :LLret12m
const CQUART_FNAMES_BRSD_D = (s::Symbol->Symbol(s,"_brsd")).(CQUART_FNAMES_D)
const CQUART_FGROUPS_BRSD_D = (s::Symbol->Symbol("G_",s)).(CQUART_FNAMES_BRSD_D)

const CQUART_FCONTROLS_BRSE_D = :LLret12m
const CQUART_FNAMES_BRSE_D = (s::Symbol->Symbol(s,"_brse")).(CQUART_FNAMES_D)
const CQUART_FGROUPS_BRSE_D = (s::Symbol->Symbol("G_",s)).(CQUART_FNAMES_BRSE_D)

const CQUART_FCONTROLS_BRSX_D = :LLret12m
const CQUART_FNAMES_BRSX_D = (s::Symbol->Symbol(s,"_brsx")).(CQUART_FNAMES_D)
const CQUART_FGROUPS_BRSX_D = (s::Symbol->Symbol("G_",s)).(CQUART_FNAMES_BRSX_D)=#
